...
•	**Inheritance:** Shared functionality across classes is implemented through base or parent classes, allowing subclasses to reuse and extend core features, especially in 
tasks like file handling and user role management.
